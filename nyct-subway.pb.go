...
//import transit_realtime "gtfs-realtime.pb"
...
type TripReplacementPeriod struct {
	...
	// dropped "transit_realtime." from TimeRange, below
...
var E_NyctFeedHeader = &proto.ExtensionDesc{
	// dropped "transit_realtime." from FeedHeader, below
...
var E_NyctTripDescriptor = &proto.ExtensionDesc{
	// dropped "transit_realtime." from TripDescriptor, below
...
var E_NyctStopTimeUpdate = &proto.ExtensionDesc{
	// dropped "transit_realtime." from TripUpdate, below
